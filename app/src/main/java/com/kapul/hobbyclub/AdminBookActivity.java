    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        etDate.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                // date picker dialog
                datePickerDialog = new DatePickerDialog(AdminBookActivity.this, new DatePickerDialog.OnDateSetListener(){
                    @Override
        ...
        tvManage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminBookActivity.this, ShowMembersActivity.class);
                value = "Book Club";
        ...
        btnPublish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (upcomingActivity.isEmpty()) {
                    ...
                    databaseReference = FirebaseDatabase.getInstance().getReference("Book Club").child("Upcoming");
        ...
        tvSignOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish();
                startActivity(new Intent(AdminBookActivity.this, MainActivity.class));
            }
        });
