...
public class AdminAstronomyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_admin_astronomy);
        ...
        etDate.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                // date picker dialog
                datePickerDialog = new DatePickerDialog(AdminAstronomyActivity.this, new DatePickerDialog.OnDateSetListener(){
                    @Override
        ...
        tvManage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminAstronomyActivity.this, ShowMembersActivity.class);
        ...
        btnPublish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (upcomingActivity.isEmpty()) {
                    ...
                    databaseReference = FirebaseDatabase.getInstance().getReference("Astronomy Club").child("Upcoming");
        ...
        tvSignOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish();
                startActivity(new Intent(AdminAstronomyActivity.this, MainActivity.class));
            }
        });
