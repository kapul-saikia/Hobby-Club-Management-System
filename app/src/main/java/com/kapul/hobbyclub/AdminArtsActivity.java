...
public class AdminArtsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_admin_arts);
        ...
        etDate.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                // date picker dialog
                datePickerDialog = new DatePickerDialog(AdminArtsActivity.this, new DatePickerDialog.OnDateSetListener(){
                    @Override
        ...
        tvManage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminArtsActivity.this, ShowMembersActivity.class);
                value = "Fine Arts Club";
        ...
        btnPublish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (upcomingActivity.isEmpty()) {
                    ...
                    databaseReference = FirebaseDatabase.getInstance().getReference("Fine Arts Club").child("Upcoming");
        ...
        tvSignOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish();
                startActivity(new Intent(AdminArtsActivity.this, MainActivity.class));
            }
        });
