...
public class AdminFilmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        etDate.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                // date picker dialog
                datePickerDialog = new DatePickerDialog(AdminFilmActivity.this, new DatePickerDialog.OnDateSetListener(){
                    @Override
        ...
        tvManage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminFilmActivity.this, ShowMembersActivity.class);
                value = "Film Sector Club";
        ...
        btnPublish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (upcomingActivity.isEmpty()) {
                    ...
                    databaseReference = FirebaseDatabase.getInstance().getReference("Film Sector Club").child("Upcoming");
        ...
        tvSignOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish();
                startActivity(new Intent(AdminFilmActivity.this, MainActivity.class));
            }
        });
