...
public class AdminDanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_admin_dance);
        ...
        etDate.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                // date picker dialog
                datePickerDialog = new DatePickerDialog(AdminDanceActivity.this, new DatePickerDialog.OnDateSetListener(){
                    @Override
        ...
        tvManage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminDanceActivity.this, ShowMembersActivity.class);
                value = "Dance Club";
        ...
        btnPublish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (upcomingActivity.isEmpty()) {
                    ...
                    databaseReference = FirebaseDatabase.getInstance().getReference("Dance Club").child("Upcoming");
        ...
        tvSignOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish();
                startActivity(new Intent(AdminDanceActivity.this, MainActivity.class));
            }
        });
